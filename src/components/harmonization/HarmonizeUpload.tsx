    ...
    return (
        <div className="w-full h-full min-h-[200px] flex flex-col">
            <Dropzone dropzone={{ accept: "image/*", maxSize: 5242880, multiple: true }} onFileUpload={onFileUpload}>
                <div
                    className={cn(
                        "flex flex-col items-center justify-center gap-4 p-6 transition-all duration-300 group-hover:bg-zinc-800/30 rounded-2xl border border-dashed border-zinc-700/50 group-hover:border-zinc-500 h-full min-h-[200px] cursor-pointer",
                        isCompact ? "py-8" : "flex-1"
                    )}>
