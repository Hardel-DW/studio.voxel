    ...
    return (
        <SimpleLayout>
            <div className="relative z-10 px-8 py-12 w-full max-w-3xl mx-auto">
                ...
                <p className="text-xl text-zinc-400 mb-12">This page does not exist, please go back to the home page or contact the support if you think this is an error.</p>
