                ...
                activeConcept.tabs.map((tab) => {
                    return (
                        <Link
                            ...
                            disabled={tab.soon}
                            className="backdrop-blur-2xl ring-1 ring-zinc-900 [&.active]:ring-zinc-600 [&.active]:bg-transparent px-4 py-2 rounded-md text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            activeProps={{
                                className: "ring-zinc-600 bg-transparent"
                            }}>
