    ...
    return (
        <div className="w-full max-w-2xl mx-auto space-y-8">
            ...
            <div className="bg-zinc-900/60 backdrop-blur-md rounded-3xl border border-white/5 p-6 shadow-xl flex items-start gap-6">
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <InputGroup label={dictionary.converter.form.name}>
                            <StyledInput
                                value={metadata.name}
                                onChange={(e) => setMetadata((prev) => ({ ...prev, name: e.target.value }))}
                            />
                        </InputGroup>
                        <InputGroup label={dictionary.converter.form.version}>
                            <StyledInput
            ...
            <div className="bg-zinc-900/60 backdrop-blur-md rounded-3xl border border-white/5 p-8 shadow-xl space-y-6">
                <InputGroup label={dictionary.converter.form.description}>
                    <textarea
                ...
                <div className="grid grid-cols-2 gap-6">
                    <InputGroup label={dictionary.converter.form.id}>
                    ...
                    <div className="flex items-end">
                        <button
                            ...
                            <span>{dictionary.converter.form.advanced}</span>
                            <span
                ...
                <div
                    ...
                    <div className="overflow-hidden space-y-6 pt-2">
                        <InputGroup label={dictionary.converter.form.authors}>
                            <div className="space-y-3">
                                ...
                                <StyledInput
                                    ...
                                    placeholder={dictionary.converter.form.authors_placeholder}
                                />
                            </div>
                        </InputGroup>

                        <div className="grid grid-cols-2 gap-6">
                            <InputGroup label={dictionary.converter.form.sources}>
                                <StyledInput
                                    type="url"
                            ...
                            <InputGroup label={dictionary.converter.form.homepage}>
                                <StyledInput
                                    type="url"
                ...
                <div className="pt-6 border-t border-white/5 flex items-center justify-between gap-6">
                    <div className="flex flex-col gap-1">
                        {error ? (
                            ...
                            <p className="text-xs text-zinc-500 max-w-xs">{dictionary.converter.form.advanced_description}</p>
                        )}
                    </div>
                    ...
                    <Button
                        ...
                        {isConverting ? (
                            ...
                            dictionary.converter.form.download
                        )}
                    </Button>
                </div>
            </div>
