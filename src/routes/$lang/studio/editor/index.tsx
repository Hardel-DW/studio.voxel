            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="space-y-4">
                    ...
                    <p className="text-xl text-zinc-300">
                        Choose a concept from the sidebar to start editing your datapack
                    </p>
                    <p className="text-sm text-zinc-400">
                        Select Enchantment, Loot Table, Recipe, or Structure to begin
                    </p>
                </div>

                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                    <LinkButton 
                        href={`/${lang}/studio/editor/enchantment/overview`}
                        variant="primary" 
                        size="lg"
                    >
                    ...
                    <LinkButton 
                        href={`/${lang}/studio/editor/loot/overview`}
                        variant="ghost" 
                        size="lg"
                    >
                        Explore Loot Tables
