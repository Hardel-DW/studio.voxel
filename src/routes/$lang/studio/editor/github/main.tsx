...
function GithubMainPage() {
    const { isGitRepository, owner, repositoryName, branch, token, isInitializing } = useExportStore();
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label htmlFor="message" className="text-xs font-semibold text-zinc-500 uppercase tracking-wider ml-1">
                                        Commit Message
                                    </label>
                                    <textarea
                                        id="message"
                                ...
                                <Button
                                    ...
                                    disabled={pushMutation.isPending || diff.size === 0 || !message}
                                    ...
                                    {pushMutation.isPending ? "Pushing Changes..." : `Commit & Push (${diff.size})`}
                                </Button>
                            </div>
